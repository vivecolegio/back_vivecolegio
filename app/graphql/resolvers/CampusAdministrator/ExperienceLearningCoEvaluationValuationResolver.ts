...
import { CampusRepository, ExperienceLearningCoEvaluationValuationRepository, ExperienceLearningRepository, StudentRepository, UserRepository } from '../../../servers/DataSource';
...
import { ExperienceLearningCoEvaluationValuation, ExperienceLearningCoEvaluationValuationConnection } from '../../models/CampusAdministrator/ExperienceLearningCoEvaluationValuation';
...
export class ExperienceLearningCoEvaluationValuationResolver {
    ...
    async createExperienceLearningCoEvaluationValuation(@Arg('data') data: NewExperienceLearningCoEvaluationValuation, @Ctx() context: IContext): Promise<ExperienceLearningCoEvaluationValuation> {
