...
import { CampusRepository, ExperienceLearningRepository, ExperienceLearningTraditionalValuationRepository, StudentRepository, UserRepository } from '../../../servers/DataSource';
...
import { ExperienceLearningTraditionalValuation, ExperienceLearningTraditionalValuationConnection } from '../../models/CampusAdministrator/ExperienceLearningTraditionalValuation';
...
export class ExperienceLearningTraditionalValuationResolver {
    ...
    async createExperienceLearningTraditionalValuation(@Arg('data') data: NewExperienceLearningTraditionalValuation, @Ctx() context: IContext): Promise<ExperienceLearningTraditionalValuation> {
