...
import { CampusRepository, ExperienceLearningCoEvaluationRepository, ExperienceLearningRepository, StudentRepository, UserRepository } from '../../../servers/DataSource';
...
import { ExperienceLearningCoEvaluation, ExperienceLearningCoEvaluationConnection } from '../../models/CampusAdministrator/ExperienceLearningCoEvaluation';
...
export class ExperienceLearningCoEvaluationResolver {
    ...
    async createExperienceLearningCoEvaluation(@Arg('data') data: NewExperienceLearningCoEvaluation, @Ctx() context: IContext): Promise<ExperienceLearningCoEvaluation> {
