...
import { CampusRepository, ExperienceLearningRepository, ExperienceLearningSelfAssessmentValuationRepository, StudentRepository, UserRepository } from '../../../servers/DataSource';
...
import { ExperienceLearningSelfAssessmentValuation, ExperienceLearningSelfAssessmentValuationConnection } from '../../models/CampusAdministrator/ExperienceLearningSelfAssessmentValuation';
...
export class ExperienceLearningSelfAssessmentValuationResolver {
    ...
    async createExperienceLearningSelfAssessmentValuation(@Arg('data') data: NewExperienceLearningSelfAssessmentValuation, @Ctx() context: IContext): Promise<ExperienceLearningSelfAssessmentValuation> {
